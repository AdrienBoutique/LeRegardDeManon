...
import { adminFormationsRouter } from "./routes/adminFormations.routes";
...
import { adminSmsRouter } from "./routes/adminSms.routes";
...
import { publicFormationsRouter } from "./routes/publicFormations.routes";
...
app.use("/api/admin", adminFormationsRouter);
...
app.use("/api/admin", adminSmsRouter);
...
app.use("/api", publicFormationsRouter);
